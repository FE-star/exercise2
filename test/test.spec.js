...
describe("大数相加add方法", function () {
  ...
  test('"99843529812342341234"加上"236124361425345435"等于"100079654173767686669"', function () {
    expect(add("99843529812342341234", "236124361425345435")).toBe(
      "100079654173767686669"
    );
  });
});
