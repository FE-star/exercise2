...
let addMap2 = (a, b) => compose(compose(R.join(""), myReverse), compose(myReduce(b), splitAndReverse))(a);
...
let compose4 = (f, g) => (a, b, c, d) => f(g(a, b, c, d));
let loop = (a, b, res, c) => {
...
let add6 = (a, b) => compose4(replaceHeadZero, loop)(a.split(""), b.split(""), "", 0);
